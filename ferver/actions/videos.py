...
def maybe_get_paginated_video_data(page, last_publish_time):
    if last_publish_time is not None:
        ...
        last_publish_time_object = datetime.fromisoformat(last_publish_time.replace("00:00Z", ""))
        ...
        videos_in_page = Video.objects.all().order_by("-published_date")[entries_to_skip + 1 : entries_to_skip + VIDEO_ENTRIES_PER_PAGE + 1]
